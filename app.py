...
# Setup rate limiter with proper initialization
limiter = Limiter(
    key_func=get_remote_address,  # Set the key function for rate limiting
    app=app,                      # Initialize the limiter with the Flask app
